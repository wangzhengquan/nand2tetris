...
/**
 * The {@code SymbolTable} class represents an symbol table of key-value
...
public class SymbolTable<Value> {
  private int n;              // size
  private Node<Value> root;   // root of SymbolTable
  ...
  /**
   * Unit tests the {@code SymbolTable} data type.
   *
  ...
  public static void main(String[] args) {
    ...
    SymbolTable<Integer> st = new SymbolTable<Integer>();
