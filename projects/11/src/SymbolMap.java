...
public class SymbolMap<Value> {
  private int n;              // size
  private Node<Value> root;   // root of SymbolMap
  ...
  /**
   * Unit tests the {@code SymbolMap} data type.
   *
  ...
  public static void main(String[] args) {
    ...
    SymbolMap<Integer> st = new SymbolMap<Integer>();
